...
const AddTransaction = (props) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (formValid.current) {
      ...
      tanggalInput.setDate(parseInt(formInput.tanggal.slice(0, 2)));
      tanggalInput.setMonth(parseInt(formInput.tanggal.slice(3, 5) - 1));
      tanggalInput.setFullYear(parseInt(formInput.tanggal.slice(6, 11)));

      props.onTambahTransactions({
  ...
  return(
    <section id="add-transaction">
      <div className="container py-5">
        <h2 className="fw-normal mb-3 text-center">Tambah Transaksi</h2>
        <hr className="2-75 mx-auto mb-4" />
        {
        !formValid.current && (
          <div className="row">
